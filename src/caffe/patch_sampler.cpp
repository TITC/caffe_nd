...
map<const string, weak_ptr<DataReader::Body> > PatchSampler::runners_;
static boost::mutex bodies_mutex_;

PatchSampler::PatchSampler(const LayerParameter& param)
...
PatchSampler:: QueuePair_Batch:: QueuePair_Batch(int size) {
